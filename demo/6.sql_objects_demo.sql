...
DESC EXTENDED race_results_python;  -- using extend get more inforamtion 
...
USING parquet
LOCATION "abfss://presentation@formula7ddl.dfs.core.windows.net/race_results_ext_sql"
...
CREATE OR REPLACE VIEW demo.pv_race_results -- premanent view
AS
SELECT *
  FROM demo.race_results_python
